"""Dilated causal front end feeding one or two LSTM layers.
...
class Net(nn.Module):
    def __init__(self, hidden_sizes, in_features=2):
        ...
        self.rnn = Recurrent(self.front.out_features, hidden_sizes, "lstm")
...
MODELS = {
    "tcn_lstm_1": lambda: Net([32]),
    "tcn_lstm_2": lambda: Net([32, 16]),
}

if __name__ == "__main__":
    run_sequence_models("TCN-LSTM", MODELS)
